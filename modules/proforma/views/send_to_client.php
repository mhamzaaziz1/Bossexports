...
<div class="modal fade email-template" data-editor-id=".<?php echo 'tinymce-'.$proforma->id; ?>" id="proforma_send_to_client_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <?php echo form_open('admin/proforma/send_to_email/'.$proforma->id); ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <?php
                            $selected = array();
                            $contacts = $this->clients_model->get_contacts($proforma->clientid,array('active'=>1,'invoice_emails'=>1));
                        ...
                        <hr />
                        <?php echo render_textarea('email_template_custom', '', $template->message, [], [], '', 'tinymce-'.$proforma->id); ?>
