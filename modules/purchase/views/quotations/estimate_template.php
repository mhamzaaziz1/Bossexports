         ...
         <div class="col-md-6">
            ...
            <div class="col-md-6">
              <div class="form-group">
                 <label for="number"><?php echo _l('PO').'#'; ?></label>
            ...
            <div class="col-md-5 form-group">
              <label for="pur_request"><?php echo _l('estimate_add_edit_number'); ?></label>
              <select name="so_request" id="sale_order" class="selectpicker"  data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>" >
                <option value=""></option>
                  <?php foreach($po_request as $s) { ?>
                  <option value="<?php echo html_entity_decode($s['id']); ?>" <?php if(isset($estimate) && $estimate->pur_request != '' && $estimate->pur_request->id == $s['id']){ echo 'selected'; } ?> ><?php echo html_entity_decode($s['prefix'].' - '.$s['number']); ?></option>
                    <?php } ?>
              </select>
              <br><br>
            </div>
            <div class="col-md-1 pad_div_0">
              <a href="#" onclick="coppy_sale_order(); return false;" class="btn btn-success mtop25" data-toggle="tooltip" title="<?php echo _l('coppy_pur_request'); ?>">
              <i class="fa fa-clone"></i>
              </a>
            </div>
            ...
            <table class="table text-right">
               <tbody>
                  <tr id="subtotal">
                     ...
                     <td width="65%" id="total_td">
                       ...
                       <div class="input-group" id="discount-total">
                              ...
                              <input type="text" onchange="dc_percent_change(this);"  disabled="true" class="form-control text-right" name="total_mn" value="" >
                  ...
                  <tr id="discount_area">
                      ...
                      <td>  
                      <?php isset($estimate)? $disc=app_format_money($estimate->discount_percent,''):$disc=0  ?>
                          <div class="input-group" id="discount-total">
                             <input type="number" value ="<?php echo $disc; ?>" onchange="dc_percent_change(this); return false;" class="form-control pull-left input-percent text-right" min="0" max="100" name="dc_percent">
                             <div class="input-group-addon">
                                <div class="dropdown">
                                   <a class="dropdown-toggle" href="#" id="dropdown_menu_tax_total_type" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                  ...
                  <tr id="discount_area">
                      ...
                      <td>  
                      <?php isset($estimate)? $disco=app_format_money($estimate->discount_total,''):$disco=0  ?>
                          <div class="input-group" id="discount-total">

                             <input type="text" value="<?php echo $disco; ?>" class="form-control pull-left text-right" onchange="dc_total_change(this); return false;" data-type="currency" name="dc_total">
