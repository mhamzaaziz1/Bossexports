               ...
               <div class="panel-body">
	                 <div class="row">
	                     <div class="col-md-4 border-right">
	                      ...
	                      <p><a href="#" class="font-medium" onclick="init_report(this,'po_report'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('Purchase Report'); ?></a></p>
	                  	 </div>
		                  <div class="col-md-4 border-right">
