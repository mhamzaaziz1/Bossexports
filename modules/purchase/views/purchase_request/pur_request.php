               ...
               <div class="panel-body">
                ...
                <div class="row">
                  ...
                  <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                      <div class="col-md-4">
                      <?php $pur_rq_code = ( isset($pur_request) ? $pur_request->pur_rq_code : $last_request->id+1354);
                    ...
                    <div class="col-md-6 form-group">
                      ...
                      <select name="vendor_id" id="vendor" class="selectpicker" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>" >
                          <option value=""></option>
                          <?php foreach($vendors as $s) { ?>
                          <option value="<?php echo html_entity_decode($s['userid']); ?>" <?php if(isset($pur_request) && $pur_request->vendor->userid == $s['userid']){ echo 'selected'; } ?>><?php echo html_entity_decode($s['company']); ?></option>
                            <?php } ?>
                      </select>
                      <br><br>
                    </div>
                    <div class="col-md-12">
                      ...
                      echo render_input('rq_description','rq_description',$rq_description); ?>
                    </div>
                    </div>
                  </div>
                  </div>
