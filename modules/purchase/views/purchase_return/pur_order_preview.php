         ...
         <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane ptop10 active" id="tab_estimate">
               <div id="estimate-preview">
                  <div class="row">
                     <span>Purchase Order related to this order <a href="<?php echo admin_url('purchase/quotations/'.$estimate->id)?>"><?php echo format_pur_estimate_number($estimate->id) ?></span></a>
