				...
				<div class="panel-body">
	              	<div class="row">    
	                    <div class="_buttons col-md-6">
	                        ...
	                        <?php }else{ ?>
	                        <a href="<?php echo admin_url('purchase/pur_order?return=1'); ?>"class="btn btn-info pull-left mright10 display-block">
	                            <?php echo _l('new_pur_order'); ?>
	                        </a><?php } ?>
	                        ...
	                        <?php } ?>
	                        <a href="<?php echo admin_url('purchase/reports'); ?>"class="btn btn-info pull-left mright10 display-block">
	                            <?php echo "Purchase Reports"; ?>
	                        </a>
				...
				<div class="col-md-12" id="small-table">
					<div class="panel_s">
                       ...
                       $custom_fields = get_custom_fields('pur_order',array('show_on_table'=>1));
                        ...
                        if($return==1){
                            render_datatable($table_data,'table_pur_return'); 
                            }else{
