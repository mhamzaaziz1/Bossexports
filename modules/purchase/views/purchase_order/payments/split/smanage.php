				...
				<div class="panel-body">
	              	<div class="row">    
	                    <div class="_buttons col-md-6">
	                        ...
	                        <a href="<?php echo admin_url('purchase/purchase_payment'); ?>"class="btn btn-success pull-left mright10 display-block">View Payments </a>
                       ...
                       $custom_fields = get_custom_fields('pur_order',array('show_on_table'=>1));
                        foreach($custom_fields as $field){
                         array_push($table_data,$field['name']);
                            ...
                            render_datatable($table_data,'table_spayment_order'); 
                            ?>
