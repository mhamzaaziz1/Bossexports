				...
				<div class="panel-body">
	              	<div class="row">    
	                    <div class="_buttons col-md-6">
	                        <?php if (1) { ?>
	                        <a href="<?php echo admin_url('purchase/payment'); ?>"class="btn btn-info pull-left mright10 display-block">
	                            <?php echo _l('new_pur_order'); ?>
	                        </a>
	                        <a href="<?php echo admin_url('purchase/purchase_spayment'); ?>"class="btn btn-success pull-left mright10 display-block">View Split Payments </a>
	              	...
	              	<div class="row">
	              		<hr>
	              		<div class="col-md-2">
	                        <?php echo render_date_input('from_date',_l('From'),''); ?>
	                    </div>
	                    <div class="col-md-2">
	                        <?php echo render_date_input('to_date',_l('To'),''); ?>
	                    </div>
                       <div class="col-md-2">
				...
				<div class="col-md-12" id="small-table">
					<div class="panel_s">
                       ...
                       $custom_fields = get_custom_fields('pur_order',array('show_on_table'=>1));
                        ...
                        // echo"123";
                            render_datatable($table_data,'table_payment_order'); 
                            ?>
...
<div class="modal fade" id="pur_supplier_no" tabindex="-2" role="dialog">
   <div class="modal-dialog">
      <div class="modal-content">
         <?php echo form_open(admin_url('purchase/supplier_invoice'),array('id'=>'pur_order-expense-form','class'=>'dropzone dropzone-manual')); ?>
         <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title"><?php echo "Add "._l('pur_order_number'); ?></h4>
         </div>
         <div class="modal-body">
            <div class="dropzone-previews"></div>
            <i class="fa fa-question-circle" data-toggle="tooltip" data-title="<?php echo "Supplier Invoice No."; ?>"></i>
            <?php echo render_input('sup_invoice','Supplier Invoice No.'); ?>
         </div>
         <div id="pur_order_inv_no"></div>
         <div class="modal-footer">
            <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo _l('close'); ?></button>
            <button type="submit" class="btn btn-info"><?php echo _l('submit'); ?></button>
         </div>
