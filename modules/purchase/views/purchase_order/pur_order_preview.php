      ...
      <?php  } ?>
               ...
               <ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
                  <li role="presentation" class="active">
                     <a href="#tab_estimate" aria-controls="tab_estimate" role="tab" data-toggle="tab">
                        <?php if ($estimate->returns==1){?>
                            <?php echo _l('pur_order').' Return'; ?>
                        <?php }else{ ?> 
         ...
         <div class="row">
            <div class="col-md-4">
              ...
              <p class="bold p_mar"><?php echo _l('Date').':'.$estimate->order_date.' '?></p>
         ...
         <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane ptop10 active" id="tab_estimate">
               <div id="estimate-preview">
                  ...
                  <div class="row">
                    <?php if ($estimate->returns==0){?>
                         <span>Purchase Order related to this order <a href="<?php echo admin_url('purchase/quotations/'.$estimate->estimate)?>"><?php echo format_pur_estimate_number($estimate->estimate) ?></span></a>
                     ...
                     <div class="col-md-6 col-sm-6">
                        <h4 class="bold">
                           ...
                           <?php if ($estimate->returns!=0){?>
                            ...
                            <?php }else{
                                echo html_entity_decode($estimate->pur_order_number.' - '.$estimate->pur_order_name);
                            }?>
                           </span>
                           </a><br>
                        </h4>
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-12 mtop15">
                        ...
                        <p><?php echo html_entity_decode($estimate->note); ?></p>
                     </div>
                     <?php } ?>
                  </div>
               </div>
