    ...
    if (has_permission('purchase', '', 'view')) {
        ...
        $module = $CI->db->get(db_prefix().'modules')->row();
           ...
           $CI->app_menu->add_sidebar_children_item('purchase', [
            'slug'     => 'purchase-items',
            'name'     => _l('Vendors Payments'),
            'icon'     => 'fa fa-clone menu-icon',
            'href'     => admin_url('purchase/purchase_payment'),
            'position' => 1,
            ]);
        $CI->app_menu->add_sidebar_children_item('purchase', [
            'slug'     => 'vendors',
        ...
        if (has_permission('purchase_quotation', '', 'view')) {
        $CI->app_menu->add_sidebar_children_item('purchase', [
        ...
        $CI->app_menu->add_sidebar_children_item('purchase', [
            'slug'     => 'contract',
            'name'     => _l('Purchase Return'),
            'icon'     => 'fa fa-file-text-o',
            'href'     => admin_url('purchase/purchase_order?return=1'),
            'position' => 6,
        ]);
...
function purchase_permissions()
{
    ...
    register_staff_capabilities('purchase', $capabilities, _l('purchase').' Full');
    ...
    register_staff_capabilities('purchase_quotation', $capabilities, "Purchase Quotation");
    ...
    register_staff_capabilities('purchase_order', $capabilities, "Purchase Order");
    ...
    register_staff_capabilities('Purchase_final', $capabilities, "Purchase");
}
...
function purchase_add_footer_components() {
    ...
    if(!(strpos($viewuri, '/admin/purchase/vendor_aging') === false)){
        echo '<script src="' . module_dir_url(PURCHASE_MODULE_NAME, 'assets/js/vendor_aging.js') .'?v=' . $CI->app_scripts->core_version().'"></script>';
    }
    ...
    if(!(strpos($viewuri, '/admin/purchase/purchase_order') === false) || !(strpos($viewuri, '/admin/purchase/purchase_payment') === false)){
        ...
        echo '<script src="' . module_dir_url(PURCHASE_MODULE_NAME, 'assets/js/payments_manage.js') .'?v=' . $CI->app_scripts->core_version().'"></script>';
    }
    if(!(strpos($viewuri, '/admin/purchase/purchase_order') === false) || !(strpos($viewuri, '/admin/purchase/purchase_spayment') === false)){
       
        // echo '<script src="' . module_dir_url(PURCHASE_MODULE_NAME, 'assets/js/purchase_order_manage.js') .'?v=' . $CI->app_scripts->core_version().'"></script>';
        echo '<script src="' . module_dir_url(PURCHASE_MODULE_NAME, 'assets/js/payments_smanage.js') .'?v=' . $CI->app_scripts->core_version().'"></script>';
    }
    if(!(strpos($viewuri, '/admin/purchase/purchase_order?return=1') === false)){
       
        echo '<script src="' . module_dir_url(PURCHASE_MODULE_NAME, 'assets/js/purchase_return_manage.js') .'?v=' . $CI->app_scripts->core_version().'"></script>';
    }
...
function purchase_head_components() {
    ...
    if(!(strpos($viewuri, '/admin/purchase/payments') === false)){
        echo '<link href="' . module_dir_url(PURCHASE_MODULE_NAME, 'assets/css/pur_order.css') .'?v=' . $CI->app_scripts->core_version().'"  rel="stylesheet" type="text/css" />';
    }
    if(!(strpos($viewuri, '/admin/purchase/pur_request') === false)){
