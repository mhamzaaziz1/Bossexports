...
(function($) {
"use strict"; 
    table_rec_campaign = $('.table-table_spayment_order');
    ...
    initDataTable('.table-table_spayment_order', admin_url+'purchase/table_spayment_order', [0], [0], Params,[1, 'DESC']);
	init_pur_order();
...
function init_pur_order(id) {
    "use strict";
    load_small_pur_order_table_item(id, '#pur_order', 'pur_orderid', 'purchase/get_pur_order_data_ajax', '.table-table_payment_order');
}
function init_spur_order(id) {
    "use strict";
    load_small_pur_order_table_item(id, '#pur_order', 'pur_orderid', 'purchase/get_pur_order_data_ajax', '.table-table_spayment_order');
}
...
function supplier_no(pur_order){
    "use strict";
    $('#pur_supplier_no').modal('show');
    // $('input[id="amount"]').val(total);
    $('#pur_order_inv_no').html('');
    //alert(pur_order);
    $('#pur_order_inv_no').append(hidden_input('pur_order',pur_order));
}
