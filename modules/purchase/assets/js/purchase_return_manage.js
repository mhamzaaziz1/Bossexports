...
(function($) {
"use strict"; 
    table_rec_campaign = $('.table-table_pur_return');
    ...
    initDataTable('.table-table_pur_return', admin_url+'purchase/table_pur_return', [0], [0], Params,[1, 'desc']);
	init_pur_order();
...
function init_pur_return(id) {
    "use strict";
    load_small_pur_order_table_item(id, '#pur_order', 'pur_orderid', 'purchase/get_pur_order_data_ajax', '.table-table_pur_return');
}
