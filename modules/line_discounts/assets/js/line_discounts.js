...
(function($) {
    ...
    function createDiscountCell( $row ) {
        ...
        if ( ld_enable_negative_discount == 1 )
            $input = $('<input type="number" class="form-control line-discount-input" name="'+item_name+'" min="-100" max="100" step="0.01" value="0">');
        else
            $input = $('<input type="number" class="form-control line-discount-input" name="'+item_name+'" min="0" max="100" step="0.01" value="0">');
    ...
    function calculateDiscountTotals() {
        ...
        if ( ld_enable_negative_discount == 1 )
            $('input[name="discount_total"]').removeAttr('min');
