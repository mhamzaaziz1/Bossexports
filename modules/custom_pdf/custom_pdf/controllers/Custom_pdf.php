...
class Custom_pdf extends AdminController
{
    ...
    public function index()
    {
        ...
        foreach (array_keys($postData['settings']) as $pdf) {
            
            if (isset($_FILES['settings']['name'][$pdf])) {
                $upload_data = $_FILES['settings']['name'][$pdf];
            ...
            if (isset($postData['settings'][$pdf]['items_table'])) {
