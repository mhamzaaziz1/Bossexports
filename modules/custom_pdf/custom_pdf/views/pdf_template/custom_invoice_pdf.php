...
$info_right_column .= '<span style="font-weight:bold;font-size:35px; "><b style="color:#0c5191;">' . _l('invoice_pdf_heading') . '</span><br />';
$info_right_column .= '<span style="font-weight:bold;font-size:20px; "><b style="color:#4e4e4e;"># ' . $invoice_number . '</b>';
