...
class Proforma_items_table extends App_items_table_template
{
    ...
    public function __construct($transaction, $type, $for = 'html', $admin_preview = false)
    {
        ...
        $this->heading_row_bg_color = !empty(getPdfOptions('proforma', 'items_table', 'heading_row_bg_color')) ? getPdfOptions('proforma', 'items_table', 'heading_row_bg_color') : get_option('pdf_table_heading_color');
        $this->heading_row_text_color = !empty(getPdfOptions('proforma', 'items_table', 'heading_row_text_color')) ? getPdfOptions('proforma', 'items_table', 'heading_row_text_color') : get_option('pdf_table_heading_text_color');

        $this->odd_rows_bg_color = !empty(getPdfOptions('proforma', 'items_table', 'odd_rows_bg_color')) ? getPdfOptions('proforma', 'items_table', 'odd_rows_bg_color') : "#ffffff";
        $this->odd_rows_text_color = !empty(getPdfOptions('proforma', 'items_table', 'odd_rows_text_color')) ? getPdfOptions('proforma', 'items_table', 'odd_rows_text_color') : "#000000";

        $this->even_rows_bg_color = !empty(getPdfOptions('proforma', 'items_table', 'even_rows_bg_color')) ? getPdfOptions('proforma', 'items_table', 'even_rows_bg_color') : "#ffffff";
        $this->even_rows_text_color = !empty(getPdfOptions('proforma', 'items_table', 'even_rows_text_color')) ? getPdfOptions('proforma', 'items_table', 'even_rows_text_color') : "#000000";

        $this->total_row_bg_color = !empty(getPdfOptions('proforma', 'items_table', 'total_row_bg_color')) ? getPdfOptions('proforma', 'items_table', 'total_row_bg_color') : "#f0f0f0";
        $this->total_row_text_color = !empty(getPdfOptions('proforma', 'items_table', 'total_row_text_color')) ? getPdfOptions('proforma', 'items_table', 'total_row_text_color') : "#000000";
    }
