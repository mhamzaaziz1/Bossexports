...
$lang['nedarimpay_pay_with_nedarim']    = 'Pay with Nedarim Plus';
$lang['nedarimpay_not_configured']      = 'Nedarim Plus is not configured. Please ask the administrator to set the Mosad ID and API Valid token in the gateway settings.';

// ── Admin invoice "Copy Pay Link" button ─────────────────────────────────────
$lang['nedarimpay_copy_payment_link']   = 'Copy Nedarim Payment Link';
$lang['nedarimpay_link_copied']         = 'Nedarim payment link copied to clipboard';
$lang['nedarimpay_link_copy_failed']    = 'Could not copy automatically — copy the link manually';
...
$lang['nedarimpay_charge_api_url_label']= 'Charge API URL';
$lang['nedarimpay_charge_api_url_help'] = 'POST endpoint for pushing occasional charges. Leave blank to use the default: https://www.matara.pro/nedarimplus/online/';
