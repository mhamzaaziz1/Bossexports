(function(){
  ...
  $('.btn_page').click(function(){
    ...
    var commodity_type = $('input[name="commodity_type"]').val();
    ChangeUrlWithIndex(page,group_id,);
      if(page!=''){
        $.post(site_url+'omni_sales/omni_sales_client/get_product_by_group/'+page+'/'+group_id+'/'+keyword+'?type='+commodity_type).done(function(response){
...
function ChangeUrlWithIndex(page, group_id) {
    ...
    var keyword = $('input[name="keyword"]').val();
    var commodity_type = $('input[name="commodity_type"]').val();
    url = url[0]+'/'+url[1]+'/'+url[2]+'/'+url[3]+'/'+url[4]+'/'+url[5]+'/'+page+'/'+group_id+'/'+keyword+'?type='+commodity_type;
