				     ...
				     <div class="fr1">
				      <div class="table-responsive s_table">
				         <table class="table invoice-items-table items table-main-invoice-edit has-calculations no-mtop">
				            <thead>
				               <tr>
				                  <th width="30%" align="center"><?php echo _l('invoice_table_item_heading'); ?></th>
				                  <th width="30%" align="center"><?php echo "Weight"; ?></th>
				                  <th width="30%" align="center"><?php echo "Volume"; ?></th>
				                ...
				                foreach ($array_list_id as $key => $product_id) { ?>
				                        <tr class="main">
				                          ...
				                          <td align="center" class="middle">
				                             <p class="weight">
		                                          	<span class="weight"><?php echo get_custom_field_value($product_id, get_custom_fields('items')[1]['id'], 'items_pr')*(int)$array_list_qty[$key]; ?></span>
		                                     </p>
				                          </td>
				                          <td align="center" class="middle">
				                             <p class="volume">
		                                          	<span class="volume"><?php echo get_custom_field_value($product_id, get_custom_fields('items')[0]['id'], 'items_pr')*(int)$array_list_qty[$key]; ?></span>
		                                     </p>
				                          </td>
				                          <td align="center" class="middle">
				      ...
				      <div class="col-md-8 col-md-offset-4">
				         <table class="table text-right">
				            <tbody>
				               ...
				               <button type="button" id="caldata" class="btn pull-right btn-info" onClick="window.location.reload();">Calculate Values</button>
				               <tr id="Weight">
				                  <td><span class="bold"><?php echo "Weight"; ?> :</span>
				                  </td>
				                  <td class="subtotal">
				                    <?php echo $tot_wei; ?>
				                  </td>
				               ...
				               <tr id="volume">
				                  <td><span class="bold"><?php echo "Volume"; ?> :</span>
				                  </td>
				                  <td class="subtotal">
				                    <?php echo $tot_vol; ?>
				                  </td>
