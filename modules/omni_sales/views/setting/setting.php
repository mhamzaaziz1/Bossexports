...
<?php init_head(); ?>
<?php 
$channel_pos = $this->omni_sales_model->get_sales_channel_by_channel('pos');
$status_pos = $channel_pos ? $channel_pos->status : 0;

$channel_portal = $this->omni_sales_model->get_sales_channel_by_channel('portal');
$status_portal = $channel_portal ? $channel_portal->status : 0;

$channel_woocommerce = $this->omni_sales_model->get_sales_channel_by_channel('woocommerce');
$status_woocommerce = $channel_woocommerce ? $channel_woocommerce->status : 0;
?>
<div id="wrapper">
	<div class="content">
		<div class="row">
