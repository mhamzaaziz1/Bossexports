...
return (new App_table('table_internal_delivery_note'))
    ->outputUsing(function ($params) {
        ...
        if (isset($day_vouchers)) {
            ...
            $where[] = ' AND ' . db_prefix() . 'internal_delivery_note.date_add <= "' . $day_vouchers . '"';
            
        }

        if (staff_cant('wh_internal_delivery_note', '', 'view')) {
        ...
        $result = data_tables_init($aColumns, $sIndexColumn, $sTable, $join, $where, ['id','internal_delivery_name']);
