            ...
            <table class="table border table-striped table-margintop" >
              <tbody>
                 ...
                 <tr class="project-overview">
                  ...
                  $CI =& get_instance();
                  ?>
                     <td><?php echo html_entity_decode(get_vendor_company_name($CI->db->query('select tblpur_orders.vendor as pur from tblpur_orders INNER JOIN tblgoods_receipt ON tblpur_orders.id = tblgoods_receipt.pr_order_id  where tblgoods_receipt.id ='.$goods_receipt->id)->row()->pur)) ; ?></td>
                  <?php   }
                 ...
                 <tr><td><b>Date: </b></td>
                 <td><?php echo _d($goods_receipt->date_c) ; ?></td></tr>
                  <tr class="project-overview">
