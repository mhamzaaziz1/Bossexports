...
hooks()->add_action('admin_init', 'spreadsheet_online_permissions');
...
function spreadsheet_online_permissions() {

    $capabilities = [];
    $capabilities['capabilities'] = [
        'view'   => _l('permission_view'),
    ];
    register_staff_capabilities('spreadsheet_online', $capabilities, 'Spreadsheet Online');
}
/**
...
{
    $CI = &get_instance();
    if (has_permission('spreadsheet_online', '', 'view')) {
