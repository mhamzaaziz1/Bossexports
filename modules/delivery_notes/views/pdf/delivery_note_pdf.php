...
$tbltotal .= '
<tr style="background-color:#0c5191;">
    <td style="color:#ffffff;" align="right" width="85%"><strong>' . _l('delivery_note_total') . '</strong></td>
    <td style="color:#ffffff;" align="right" width="15%">' . $total . '</td>
</tr>';
