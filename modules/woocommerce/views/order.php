                           ...
                           <p>Order ID </p>
                               <div class="form-group">
                                   ...
                                   <select class="form-control" id="status" name="status" required>
                                       <option value="pending" <?php if ($order->status == 'pending') {echo "selected";} ?> ><?php echo html_escape(_l('pending')) ?></option>
                                       <option value="processing" <?php if ($order->status == 'processing') {echo "selected";} ?> ><?php echo html_escape(_l('processing')) ?></option>
                                       <option value="on-hold" <?php if ($order->status == 'on-hold') {echo "selected";} ?> ><?php echo html_escape(_l('on_hold')) ?></option>
                                       <option value="completed" <?php if ($order->status == 'completed') {echo "selected";} ?> ><?php echo html_escape(_l('completed')) ?></option>
                                       <option value="cancelled" <?php if ($order->status == 'cancelled') {echo "selected";} ?> ><?php echo html_escape(_l('cancelled')) ?></option>
                                       <option value="refunded" <?php if ($order->status == 'refunded') {echo "selected";} ?> ><?php echo html_escape(_l('refunded')) ?></option>
                                       <option value="failed" <?php if ($order->status == 'failed') {echo "selected";} ?> ><?php echo html_escape(_l('failed')) ?></option>
                                   </select>
                             </div>
                           </div>
                             <div class="modal-footer">
...
<div class="modal fadeIn" id="invoiceModal" role="dialog">
  ...
  <?php echo form_open(admin_url('woocommerce/woocommerce_invoice/create_invoice')); ?>
           <div class="modal-body">
               ...
               <?php 
               $selected = (isset($order->customer_id) ? $invoice->clientid : '');
