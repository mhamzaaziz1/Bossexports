...
<script>
    function calculateTotal() {
        ...
        const shippingExpense = parseFloat($('#ship_expense').val()) || 0;
        //alert($('#ship_expense').val());
        const otherExpense = parseFloat($('#other_expense').val()) || 0;
        const total1 = parseFloat($('.total').first().text().replace('R', '').trim()) || 0; // Get the first element with class 'total'

        // Calculate total
        const total = shippingExpense + otherExpense + total1;

        // Update total in the HTML
        $('#total').text(total.toFixed(2)); // Assuming you have an element with id 'total'
        $('input[name="total"]').val(total.toFixed(2)); // Update hidden input

        // Update all total
        const allTotal = total; // Assuming all total is the same as total for now
        $('.total_all').text(allTotal.toFixed(2)); // Update all total
    }
</script>
...
<div class="panel-body mtop10">
   ...
   <div class="col-md-8 col-md-offset-4">
       ...
       <span class="bold">Total Weight:</span><span id="weight" class="bold"> </span><br>
       <span class="bold">Total Volume:</span><span id="volu" class="bold"> </span>
         ...
         <tbody>
               ...
               <td>
                  <div class="row">
                     ...
                     <div class="col-md-5" hidden>
                        <input id="adj"   type="number" data-toggle="tooltip" data-title="<?php echo _l('numbers_not_formatted_while_editing'); ?>" value="" class="form-control pull-left" name="adjustment">
                     </div>
                     <div class="col-md-3">
            ...
            <tr>
               <td>
                  <div class="row">
                     <div class="col-md-12 ">
                        <span class="bold"><?php echo _l('Shipping Expense (will effect All Total)'); ?></span>
                     </div>
                  </div>
               </td>
            ...
            <tr>
               <td>
                  <div class="row">
                     <div class="col-md-12">
                        <span class="bold"><?php echo _l('Other Expenses (will effect All Total)'); ?></span>
                     </div>
                  </div>
               </td>
