   ...
   <div class="panel_s mbot10">
      <div class="panel-body _buttons">
         ...
         <?php if(1){ ?>
            ...
            <a href="<?php echo admin_url('invoices'); ?>" class="btn btn-info pull-left new new-invoice-list mright5"><?php echo _l('View Invoices'); ?></a>
         <?php } ?>
      ...
      <div class="col-md-12" id="small-table">
         <div class="panel_s">
            <div class="panel-body">
               ...
               <?php $this->load->view('admin/invoices/split/table_html'); ?>
            </div>
         </div>
      </div>
