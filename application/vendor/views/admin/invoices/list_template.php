   ...
   <div class="panel_s mbot10">
      <div class="panel-body _buttons">
         ...
         <?php if(1){ ?>
            ...
            <a href="<?php echo admin_url('invoices?split=1'); ?>" class="btn btn-info pull-left new new-invoice-list mright5"><?php echo _l('View Split invoices'); ?></a>
            <a href="<?php echo admin_url('invoices/allpaid'); ?>" class="btn btn-info pull-left new new-invoice-list mright5"><?php echo _l('Mark all as paid'); ?></a>
         <?php } ?>
         <?php if(!isset($project)){ ?>
               <a href="<?php echo admin_url('invoices/recurring'); ?>" class="btn btn-info pull-left">
                  <?php echo _l('Last Month'); ?>
               </a>
         <?php } ?>
