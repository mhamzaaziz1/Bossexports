   ...
   <div class="panel-body mtop10">
      <div class="row">
         ...
         <?php //var_dump($invoice->clientid)?>
            <?php $this->load->view('admin/invoice_items/item_select', $invoice); ?>
         </div>
         ...
         <table class="table invoice-items-table items table-main-invoice-edit has-calculations no-mtop">
            ...
            <tbody>
               <tr class="main">
                  ...
                  <td>
                     <input type="number" name="rate" class="form-control" placeholder="<?php echo _l('item_rate_placeholder'); ?>" readonly>
                  </td>
                  <td>
                     <?php
               ...
               <tr>
                  <td hidden>
                     ...
                     <div class="col-md-2" hidden>
                        <input id="adj"   type="number" data-toggle="tooltip" data-title="<?php echo _l('numbers_not_formatted_while_editing'); ?>" value="0" class="form-control pull-left" name="adjustment">
                     </div>
                     <div class="col-md-7" >
