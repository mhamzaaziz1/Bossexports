...
<div id="directors-report" class="hide">
   <div class="row">
      <div class="col-md-4">
...
<table class="table table-directors-report scroll-responsive">
   <thead>
      <tr>
         ...
         <?php } ?>
         <th><?php echo _l('FNB'); ?></th>
         <th><?php echo _l('NED'); ?></th>
         <th><?php echo _l('Others payment'); ?></th>
         <th><?php echo _l('Balance open'); ?></th>
         <th><?php echo _l('report_invoice_status'); ?></th>
         <th><?php echo _l('Left to pay'); ?></th>
      </tr>
   </thead>
   <tbody></tbody>
   <tfoot>
