...
<script>
    ...
    var report_directors = $('#directors-report');
    ...
    var fnServerParams = {
        ...
        "sale_product_items": '[name="sale_product_items"]',
    ...
    $(function() {
        $('select[name="currency"],select[name="invoice_status"],select[name="estimate_status"],select[name="sale_agent_invoices"],select[name="sale_product_items"],select[name="sale_agent_items"],select[name="sale_agent_estimates"],select[name="payments_years"],select[name="proposals_sale_agents"],select[name="proposal_status"],select[name="credit_note_status"]').on('change', function() {
            gen_reports();
        });
    ...
    function init_report(e, type) {
        ...
        } else if (type == 'directors-report') {
            report_directors.removeClass('hide');
    ...
    function directors_report() {
        if ($.fn.DataTable.isDataTable('.table-directors-report')) {
            $('.table-directors-report').DataTable().destroy();
        }
        initDataTable('.table-directors-report', admin_url + 'reports/directors_report', false, false, fnServerParams, [
            [2, 'desc'],
            [0, 'desc']
        ]);
    }
    ...
    function gen_reports() {
        ...
        if (!$('.chart-income').hasClass('hide')) {
            ...
            invoices_report();
        } else if (!report_directors.hasClass('hide')) {
            directors_report();
