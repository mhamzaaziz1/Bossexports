            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        <h4 class="no-margin">
                            <?php echo _l('contact_items_report'); ?>
                            <?php if(isset($contact_name) && !empty($contact_name)): ?>
                        ...
                        $contact_id = isset($contact_id) ? $contact_id : '';
                        echo form_open(admin_url('reports/contact_items_report/'.$contact_type.'/'.$contact_id), ['method' => 'post', 'id' => 'contact-items-report-form']); 
                        ?>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="transaction_type" id="transaction_type" class="form-control selectpicker">
                                        ...
                                        <?php elseif($contact_type == 'vendor'): ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="ranking" id="ranking" class="form-control selectpicker">
                                        <option value="most" <?php if(isset($selected_ranking) && $selected_ranking == 'most'){echo 'selected';} ?>><?php echo _l('most_bought'); ?></option>
                                        <option value="least" <?php if(isset($selected_ranking) && $selected_ranking == 'least'){echo 'selected';} ?>><?php echo _l('least_bought'); ?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                foreach($report_data as $row) {
                                    ...
                                    $group_name = isset($row['group_name']) && !empty($row['group_name']) ? $row['group_name'] : _l('ungrouped');
                                    ...
                                    $grouped_items[$group_id]['items'][] = $row;
                                }
                                ?>

                                <?php foreach($grouped_items as $group_id => $group): ?>
                                <div class="panel-group" id="accordion_<?php echo $group_id; ?>" role="tablist" aria-multiselectable="true">
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="heading_<?php echo $group_id; ?>">
                                            <h4 class="panel-title">
                                                <a role="button" data-toggle="collapse" data-parent="#accordion_<?php echo $group_id; ?>" href="#collapse_<?php echo $group_id; ?>" aria-expanded="true" aria-controls="collapse_<?php echo $group_id; ?>">
                                                    <?php echo $group['name']; ?>
                                                </a>
                                            </h4>
                                        </div>
                                        <div id="collapse_<?php echo $group_id; ?>" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_<?php echo $group_id; ?>">
                                            <div class="panel-body">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered table-striped">
                                                        <thead>
                                                            <tr>
                                                                <th><?php echo _l('product_sku'); ?></th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <?php if(isset($row['item_id']) && !empty($row['item_id'])): ?>
                                                                        <a href="<?php echo admin_url('invoice_items/item/'.$row['item_id']); ?>" target="_blank"><?php echo $row['code']; ?></a>
                                                                    <?php else: ?>
...
$(function() {
    ...
    $('#report_months').on('change', function() {
        ...
        appValidateForm($('#contact-items-report-form'), validationRules);
    });
