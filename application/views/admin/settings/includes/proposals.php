...
?>
<h4 class="bold"><?= _l('PDF Settings'); ?></h4>
<hr />
<?= render_textarea('settings[proposal_pdf_header]', 'PDF Header', get_option('proposal_pdf_header'), ['rows' => 4]); ?>
<p class="text-muted">Custom text to appear at the top of proposal PDFs</p>
<hr />
<?= render_textarea('settings[proposal_pdf_footer]', 'PDF Footer', get_option('proposal_pdf_footer'), ['rows' => 4]); ?>
<p class="text-muted">Custom text to appear at the bottom of proposal PDFs</p>
