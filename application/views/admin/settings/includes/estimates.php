...
<hr />
<?= render_textarea('settings[estimate_pdf_header]', 'PDF Header', get_option('estimate_pdf_header'), ['rows' => 4]); ?>
<p class="text-muted">Custom text to appear at the top of estimate PDFs</p>
<hr />
<?= render_textarea('settings[estimate_pdf_footer]', 'PDF Footer', get_option('estimate_pdf_footer'), ['rows' => 4]); ?>
<p class="text-muted">Custom text to appear at the bottom of estimate PDFs</p>
