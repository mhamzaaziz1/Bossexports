...
<?php init_tail(); ?>
<!-- Include DataTables RowGroup Extension -->
...
<script>
    $(function() {
        ...
        function generateCashbook2Report() {
            ...
            // Initialize the table using the standard initDataTable function
            initDataTable('.table-cashbook2-report', admin_url + 'reports/cashbook2_report', [], [], fnServerParams, [[1, 'asc'], [0, 'asc']]);

            // Add rowGroup functionality after initialization
            var table = $('.table-cashbook2-report').DataTable();

            // Configure rowGroup without subtotals
            table.rowGroup({
                dataSrc: 1, // Customer name column
                startRender: function(rows, group) {
                    return '<span class="group-header">' + group + '</span>';
                }
            });

            // Customer name column is now visible
