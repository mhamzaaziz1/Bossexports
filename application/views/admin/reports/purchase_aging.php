          ...
          <div class="row">
            <div class="col-md-12">
              <div class="text-right mtop15">
                <button type="button" class="btn btn-info" onclick="gen_reports();"><?php echo _l('generate'); ?></button>
              </div>
            </div>
          </div>
...
<script>
  $(function() {
    // Initialize the purchase aging report when the page loads
    if (typeof(init_report) !== 'undefined') {
      // Add purchase aging report to the init_report function
      var originalInitReport = init_report;
      init_report = function(e, type) {
        if (type == 'purchase-aging-report') {
          // Hide all reports
          $('div[id$="-report"]').addClass('hide');
          // Show the purchase aging report
          $('#purchase-aging-report').removeClass('hide');
    ...
    // Add purchase aging report to the gen_reports function
