      ...
      <div class="row">
         <div class="col-md-12">
            <div class="panel_s">
               <div class="panel-body">
                  <div class="row">
                     <div class="col-md-4 border-right">
                      ...
                      <hr />
                      <p>
                        <a href="#" class="font-medium" onclick="init_report(this,'directors-report'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('Directors Report(Sales + Payment)'); ?></a>
                      </p>
                      <p>
               ...
               <hr class="hr-panel-heading" />
               <?php $this->load->view('admin/reports/includes/sales_directors'); ?>
