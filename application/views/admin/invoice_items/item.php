    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <label for="rate" class="control-label">
                            ...
                            <input type="number" id="rate" name="rate" class="form-control" value="" readonly>
                        </div>
                        <?php
                            foreach($currencies as $currency){
                                ...
                                <div class="form-group">
                                    <label for="rate_currency_<?php echo $currency['id']; ?>" class="control-label">
                                        ...
                                        <input type="number" id="rate_currency_<?php echo $currency['id']; ?>" name="rate_currency_<?php echo $currency['id']; ?>" class="form-control" value="" readonly>
                                    </div>
                             <?php   }
                            }
                        ?>
                ...
                <?php echo render_input('unit','unit', readyonly); ?>
    ...
    $("body").on('show.bs.modal', '#sales_item_modal', function (event) {
        ...
        if (typeof (id) !== 'undefined') {
            ...
            requestGetJSON('invoice_items/get_item_by_id/' + id).done(function (response) {
                ...
                $itemModal.find('input[name="rate"]').val(response.rate).prop("readonly", true);
