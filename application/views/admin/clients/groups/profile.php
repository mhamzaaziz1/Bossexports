         ...
         <div role="tabpanel" class="tab-pane<?php if(!$this->input->get('tab')){echo ' active';}; ?>" id="contact_info">
            <div class="row">
               ...
               <div class="col-md-6">
                  ...
                  <?php }
                  $value=( isset($client) ? $client->balance : '0');
                     echo render_input( 'balance', 'balance',$value);
                     $selected = array();
               ...
               <div class="col-md-6">
                  ...
                  <?php $countries= get_all_countries();
                     ...
                     <label>Tax Type</label>
                        ...
                        <select name="ttype" id="ttype" class="form-control selectpicker" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">>
                    ...
                    <label >Price Group</label>
                        ...
                        <select name="pgroup" id="pgroup" class="form-control selectpicker" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">>>
