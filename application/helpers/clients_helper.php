...
function app_init_customer_profile_tabs()
{
    ...
    // Add the Most/Least Items Bought tab
    $CI->app_tabs->add_customer_profile_tab('purchase_summary', [
        'name'     => _l('purchase_summary'),
        'icon'     => 'fa fa-shopping-cart',
        'view'     => 'admin/clients/groups/purchase_summary',
        'position' => 95,
    ]);
