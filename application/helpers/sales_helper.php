...
/**
 * Get all items by type with full details (extended version)
 * Similar to get_items_by_type but can include additional item information
 *
 * @param string $type rel_type value
 * @param mixed  $id
 *
...
{
    // For now, this is identical to get_items_by_type
    // This function exists to support code that expects it
    // Can be extended in the future to include more details  
    return get_items_by_type($type, $id);
}
/**
