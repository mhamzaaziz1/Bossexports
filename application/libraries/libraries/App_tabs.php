...
class App_tabs
{
    ...
    public function add_settings_section($slug, $tab)
    {
        $this->ci->app->add_settings_section_child('other', $slug, $tab);

        _deprecated_function('app->add_settings_section ', '3.2.0', 'app->add_settings_section');

        return $this;
    }

    public function add_settings_section_children_item($parent_slug, $tab)
    {
        $this->add_child($parent_slug, $tab, 'settings');

        _deprecated_function('app->add_settings_section _children_item', '3.2.0', 'app->add_settings_section_child');
