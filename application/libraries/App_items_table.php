...
class App_items_table extends App_items_table_template
{
    ...
    public function items()
    {
        ...
        foreach ($this->items as $item) {
            ...
            if (!empty($item['description'])) {
                $itemHTML .= '<span style="font-size:' . 14 . 'px;"><strong>'
    ...
    {
        $html = '<tr style="color:#424242; font-size:14px">';
    ...
    public function pdf_headings()
    {
        ...
        $tblhtml = '<tr bgcolor="' . get_option('pdf_table_heading_color') . '" style="color:' . get_option('pdf_table_heading_text_color') . '; font-size:14px">';
