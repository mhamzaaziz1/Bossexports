...
abstract class App_pdf extends TCPDF
{
    ...
    public function Footer()
    {
        ...
        if (get_option('show_page_number_on_pdf') == 1) {
            ...
            $this->Cell(0, 15, 'E&OE | INCOTERMS: ExW | ALL GOODS REMAIN PROPERTY OF BOSS EXPORTS UNTIL FULLY PAID FOR. | '.$this->getAliasNumPage() . '/' . $this->getAliasNbPages(), 0, false, 'C', 0, '', 0, false, 'T', 'M');
        }
    }
